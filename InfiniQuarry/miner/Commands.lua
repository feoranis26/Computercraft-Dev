...
table.insert(commands, Command:new("UPDATE_YLEVEL", function(args) miner.yLevel = tonumber(args) end, false))
...
table.insert(commands, Command:new("SET_HELPER", function(args) miner.helper = toboolean(args) end, false))